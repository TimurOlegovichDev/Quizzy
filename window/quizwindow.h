...
/**
 * @brief Класс представляет собой окно квиза. Пользователь может выбирать варианты ответа
 * имеется автоматический контроллер времени, по завершению квиза, будет автоматическое
 * переключение на окно статистики.
 */
